...
const BLOG = {
  AUTHOR: '龙葵', // 作者
  BIO: '一个唯物主义者', // 作者简介
  LINK: 'https://www.longkui.cc', // 网站地址
  KEYWORDS: '龙葵，博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '548da459606f4ec4866cc787b0d24327', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: '2769339589@qq.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/2769339589', // 你的github个人主页
  CONTACT_TELEGRAM: '2769339589@qq.com', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'https://github.com/2769339589', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || '2769339589/ik', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/
  ...
  COMMENT_VALINE_SERVER_URLS: process.env.NEXT_PUBLIC_VALINE_SERVER_URLS || 'https://waline.longkui.cc', // 该配置适用于国内自定义域名用户, 海外版本会自动检测(无需手动填写) @see https://valine.js.org/configuration.html#serverURLs
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://www.longkui.cc/', // 请配置完整的Waline评论地址 例如 hhttps://preview-waline.tangly1024.com @see https://waline.js.org/guide/get-started.html
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'longkui', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
